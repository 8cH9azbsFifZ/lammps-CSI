...
#include "pointers.h"
#include "compute_ackland_atom.h" // for friend declaration
#include "compute_centro_atom.h" // works without; included for consistency
...
class Thermo : protected Pointers {
  ...
  friend class FixIndent;              // accesses force on indenter
  friend class ComputeCentroAtom;
  friend class ComputeAcklandAtom;
 ...
 private:
  ...
  // compute indenter properties
  int IndexFixIndent, IndexFixIndentBad;
  int FindIndexFixIndent();
  void compute_indFX();
  void compute_indFY();
  void compute_indFZ();
  void compute_indNc();
  ...
  void compute_indY();
  void compute_indZ();
  void compute_indAcAtomarMax();
  void compute_indAcAtomarProjected();
  void compute_indAcBrinell();
  void compute_indAcMeyer();
  void compute_indAcElliptic();
  void compute_indPlasticDepth();

  // Ackland Concentrations
  int IndexComputeAckland, IndexComputeAcklandBad;
  int FindIndexComputeAckland();
  void compute_cAckUNKNOWN();
  void compute_cAckICO();
  void compute_cAckBCC();
  void compute_cAckFCC();
  void compute_cAckHCP();
};
