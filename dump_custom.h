...
class DumpCustom : public Dump {
 ...
 private:
  ...
  int index_epair,index_ke,index_etotal,index_centro,index_stress,index_ackland;
  char *style_epair,*style_ke,*style_etotal,*style_centro,*style_stress,*style_ackland;
  ...
  void pack_ackland(int);
  void pack_sMises(int);
  void pack_sTrace(int);
  void pack_sFull(int);
  void pack_sxx(int);
  void pack_syy(int);
  void pack_szz(int);
